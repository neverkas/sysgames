...
<?php ++$count; ?>
	...
	<div id="<?php echo $ticket; ?>" class="block-data <?php echo $status_class; ?>">
		...
		<div class="row-data align-left row-with-medium">
			...
			<input class='field-data' type="text" name="admin-name" value="<?php echo $admin_name; ?>" />
		</div>
		<div class="row-data align-left row-with-medium">
			<span><?php echo $server_name; ?></span>
			<input class='field-data' type="text" name="server-name" value="<?php echo $server_name; ?>" />
		</div>
		<div class="row-data align-left row-with-medium">
			<span><?php echo $admin_type; ?></span>
			<input class='field-data' type="text" name="admin-type" value="<?php echo $admin_type; ?>" />			
		</div>
		<div class="row-data align-left row-with-medium">
			<span><?php echo $admin_password; ?></span>
			<input class='field-data' type="text" name="admin-password" value="<?php echo $admin_password; ?>" />			
		</div>
		<div class="row-data align-left row-with-medium">
			<span>$<?php echo $admin_price; ?></span>
			<input class='field-data' type="text" name="admin-price" value="<?php echo $admin_price; ?>" />			
		</div>
		<div class="row-data align-left row-with-medium">
